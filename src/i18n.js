...
(function (root, factory) {
  ...
  const STR = {
    zh: {
      ...
      breakNow: '現在就休息', schedule: '時間表', library: '動作示範庫',
      d1: '第 1 天', d2: '第 2 天', d3: '第 3 天', rest: '休息', restDay: '休息日', noTraining: '今天不用練', dayOff: '非上班日',
      todayProgress: '今天進度', setsUnit: '組', setsOf: '{a}/{b} 組', pausedTillTomorrow: '已暫停到明天',
      nextBreak: '下次休息', lastBreak: '最後一次', noBreaksToday: '今天沒有排休息', catchUp: '補做', nextSlot: '下一次',
      ...
      pauseReminders: '暫停提醒', pauseRemindersUntil: '暫停提醒（到 {t}）', openMain: '打開主視窗', launchAtLoginMenu: '開機自動啟動',
    ...
    en: {
      ...
      breakNow: 'Break Now', schedule: 'Schedule', library: 'Exercises',
      d1: 'Day 1', d2: 'Day 2', d3: 'Day 3', rest: 'Rest', restDay: 'Rest Day', noTraining: 'No Workout Today', dayOff: 'Day Off',
      todayProgress: 'Progress', setsUnit: 'sets', setsOf: '{a}/{b} sets', pausedTillTomorrow: 'Paused until tomorrow',
      nextBreak: 'Next Break', lastBreak: 'Last Break', noBreaksToday: 'No breaks today', catchUp: 'Catch-up', nextSlot: 'Next',
      ...
      secs: '{n} s', inTime: 'in {t}', startingSoon: 'Starting soon', close: 'Close',
      ...
      pauseReminders: 'Pause Reminders', pauseRemindersUntil: 'Pause Reminders (until {t})', openMain: 'Open BreakFit', launchAtLoginMenu: 'Open at Login',
